...
username.LayoutOrder = 1 -- This sets the order relative to other siblings
username.Parent = userAndDisplayFrame
username.Size = UDim2.fromScale(1,0)

   local premium = Instance.new("TextLabel")
   premium.Name = "Premium"
   premium.FontFace = Font.new(
       assets.interFont,
       Enum.FontWeight.SemiBold,
       Enum.FontStyle.Normal
   )
   premium.Text = "Premium"
   premium.TextColor3 = Color3.fromRGB(50, 255, 50)
   premium.TextSize = 10
   premium.TextTransparency = 0.5
   premium.TextTruncate = Enum.TextTruncate.SplitWord
   premium.TextXAlignment = Enum.TextXAlignment.Left
   premium.TextYAlignment = Enum.TextYAlignment.Top
   premium.AutomaticSize = Enum.AutomaticSize.XY
   ...
   premium.LayoutOrder = 2 -- Place after username (ensure this is greater than username LayoutOrder)
   premium.Parent = userAndDisplayFrame
   premium.Size = UDim2.fromScale(1,0)
...
local function _SetUserInfoState(State)
    print("_SetUserInfoState called with State:", State) -- Add this line

    if State then
        headshot.Image = (isReady and headshotImage) or "rbxassetid://0"
        username.Text = "@" .. LocalPlayer.Name
        displayName.Text = LocalPlayer.DisplayName
        -- Show the premium label when user info is visible:
        print("Setting premium visibility to true") --Add this Line
        ...
        -- Hide the premium label when user info is redacted:
        print("Setting premium visibility to false") -- Add this line
